...
> **🇯🇵 日本語** | [English](#collectivescience-1)

CollectiveScienceは、科学的知識をClaim中心グラフとして表現し、分野横断的な概念的つながりを探索するプロトタイププラットフォームです。
...
科学的概念は、異なる分野で異なる名前、仮定、形式体系のもとに現れることがあります。CollectiveScienceは、Claim、Context、Evidence、分野横断的接続をファーストクラスオブジェクトとして扱うことで、それらの関係を検査可能にすることを目指しています。
